...
flags.DEFINE_string(
    "input_file", "./tmp/train_one.tfrecord,./tmp/train.tfrecord",
...
flags.DEFINE_integer("num_train_steps", 40, "Number of training steps.")
...
def get_masked_lm_output(bert_config, input_tensor, output_weights, factorize_weight, positions,
  ...
  with tf.variable_scope("cls/predictions"):
	...
	### factorized weight #########
    output_weights = tf.matmul(output_weights, factorize_weight)
